...
function love.conf(t)
    ...
    t.window.title = "xx"         -- The window title (string)
    t.window.icon = nil                 -- Filepath to an image to use as the window's icon (string)
    t.window.width = 148*cfg_gw*cfg_scale             -- The window width (number)
    t.window.height = 148*(cfg_gh+2)*cfg_scale               -- The window height (number)
